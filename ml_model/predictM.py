...
ap.add_argument("-i", "--input", required= False,default="wildfire.mp4",
	help="path to our input video")
ap.add_argument("-o", "--output", required=False,default="output.avi",
...
print("loading ndd Ai model and labels")
